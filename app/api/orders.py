...
async def checkout_cart(
    ...
    """
    Authenticated user: Process cart checkout and create an order with stock deduction.
    """
    return await order_service.create_order(db, current_user.id, order_in)
...
async def get_order_details(
    ...
    """
    Retrieve order details by ID (User can view own order; Admin/Manager can view any).
    """
...
async def update_status(
    ...
    """
    Admin/Manager-only: Update order fulfillment status.
    """
